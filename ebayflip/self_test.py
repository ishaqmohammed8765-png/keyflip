...
def run_self_tests() -> None:
    ...
    assert broadened == "iPhone 13 for sale used listing", f"Unexpected broadened query: {broadened}"
    broadened = _broaden_query("iphone14")
    assert broadened == "iphone 14 for sale used listing", f"Unexpected broadened query: {broadened}"
